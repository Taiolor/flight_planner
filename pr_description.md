...
🔧 **Fix:** Added `.max(255)` limits to string validation schemas in authentication and notification endpoints, and appropriate `.max(255)` limits to date/holiday inputs to ensure payloads remain small and manageable.
