...
export function NotificationSettingsPopup({
  ...
  return (
    <div className="relative" ref={popupRef}>
      ...
      {open && (
        <div
          className="absolute right-0 top-10 z-50 w-80 rounded-xl shadow-2xl border border-white/10 bg-slate-900 text-white overflow-hidden"
        ...
        >
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded-full bg-blue-500 flex items-center justify-center text-xs font-bold text-white">1</div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded-full bg-orange-500 flex items-center justify-center text-xs font-bold text-white">2</div>
            ...
            {(aviso1 > 0 || aviso2 > 0) && (
              <div className="rounded-lg bg-slate-800/60 border border-slate-700 p-3 space-y-1">
                <p className="text-xs text-slate-400 font-medium mb-1.5">Resumo dos avisos ativos:</p>
                {aviso1 > 0 && (
                ...
                {aviso1 === 0 && aviso2 === 0 && (
                  <p className="text-xs text-slate-500">Nenhum aviso ativo.</p>
                )}
              </div>
            )}
