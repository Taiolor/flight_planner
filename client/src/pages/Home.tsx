                                      ...
                                      {!!week.isTicketIssued && (
                                        <div className="flex-1 flex flex-col gap-3">
                                          ...
                                          <div className="flex items-center gap-2">
                                            ...
                                            <div className="flex rounded-lg overflow-hidden border border-slate-200 shadow-sm">
                                              ...
                                              <button
                                                ...
                                                className={`px-3 py-1 text-xs font-semibold transition-colors border-l border-slate-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-inset ${
                                                  (tempTicketType[
                                                    week.weekNumber
                                                  ] ?? "roundtrip") === "oneway"
                                          ...
                                          <button
                                            ...
                                            className="w-full py-3 rounded-2xl bg-slate-900 text-white text-sm font-semibold shadow-lg hover:bg-slate-800 active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-60 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-500"
                                            onClick={() => {
                                              if (!isAuthenticated) {
                                                setShowLoginModal(true);
                                                return;
                                                ...
                                                <div className="border border-slate-200 rounded-xl overflow-hidden">
                                                  ...
                                                  <div className="p-2 flex flex-col gap-1.5">
                                                    ...
                                                    <button
                                                      ...
                                                      className="w-full flex items-center justify-center gap-1.5 py-1.5 px-2 rounded-lg bg-slate-100 hover:bg-slate-200 transition-colors text-[11px] font-medium text-slate-700 border border-slate-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
                                                    >
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="text-xs text-blue-600 hover:text-blue-800 font-medium px-2 py-1 rounded hover:bg-blue-50 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 rounded-sm"
                ...
                <button
                  ...
                  className="text-xs text-slate-500 hover:text-slate-700 font-medium px-2 py-1 rounded hover:bg-slate-100 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 rounded-sm"
              ...
              {airlines.map(airline => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium border-2 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
                      isSelected
