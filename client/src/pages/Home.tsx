...
export default function Home() {
  ...
  // Precompute the lowest price for each week to avoid expensive calculations on every render and filter
  // ⚡ Bolt Optimization: reduces O(n) array allocations per call to O(1) property lookup
